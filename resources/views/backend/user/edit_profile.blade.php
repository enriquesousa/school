        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <h6 class="box-subtitle">Para actualizar datos de tu perfil en la <a class="text-warning"
                            href="#">base de
                            datos</a>
                    </h6>
                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {{-- Select Sexo --}}
                                                <div class="form-group">
                                                    <h5>Sexo&nbsp;<i class="fa fa-fw fa-venus-mars"></i>&nbsp;<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <select name="gender" id="gender" required=""
                                                            class="form-control">
                                                            <option value="" selected="" disabled="">Seleccionar Sexo
                                                            </option>
