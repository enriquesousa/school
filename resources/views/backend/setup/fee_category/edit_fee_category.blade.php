        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h4 class="box-title">Editar Categoría de Cobro - Estudiante</h4>
                    <h6 class="box-subtitle">Para Editar Categoría de Cobro a estudiante en la <a class="text-warning"
                            href="#">base
                            de datos </a>
                    </h6>
                </div>
