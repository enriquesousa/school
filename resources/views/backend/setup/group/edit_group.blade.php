        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h4 class="box-title">Editar Grupo - Estudiante</h4>
                    <h6 class="box-subtitle">Para editar un Grupo en la <a class="text-warning"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <h5>Editar Grupo <span class="text-danger">*</span></h5>
                                            <div class="controls">
