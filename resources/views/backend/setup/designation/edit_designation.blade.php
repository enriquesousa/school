        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <h6 class="box-subtitle">Para editar designación en la <a class="text-warning" href="#">base de datos</a></h6>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name" value="{{ $editData->name }}" class="form-control" required autofocus>
                                                @error('name')
