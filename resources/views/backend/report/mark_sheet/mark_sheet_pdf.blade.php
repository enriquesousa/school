                ...
                <div class="col-12">
                    ...
                    <div class="box bb-3 border-warning">
                        ...
                        <div class="box-body" style="border: solid 1px; padding: 10px;">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Calificación con Letra</th>
                                                <th class="text-center">Puntos de Grado</th>
                                            </tr>
                                        </thead>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        ...
                                        $total_grade = App\Models\MarksGrade::where([['start_point','<=',$point_for_letter_grade],['end_point','>=',$point_for_letter_grade]])->first();
                                            ...
                                            @endphp
                                            <tr>
                                                <td width="50%"><strong>Puntos Promedio Todas las Materias</strong></td>
                                                <td width="50%">
                                                    @if($count_reprobados > 0)
                                                        0.00
                                                    @else
                                            ...
                                            <tr>
                                                <td width="50%"><strong>Grado con Letra</strong></td>
                                                <td width="50%">
                                                    @if($count_reprobados > 0)
                                                        F
                                                    @else
                                            ...
                                            <tr>
                                                <td width="50%">Total de Calificaciónes con fracción</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;"><strong>Comentarios:</strong>
                                                    @if($count_reprobados > 0)
                                                        Fail
                                                    @else
                                                        {{ $total_grade->remarks }}
                            ...
                            {{-- Row 6 Firmas del Maestro, Padre y Director--}}
                            <div class="row">
                                <!--  6th row start -->
                                <div class="col-md-4">
                                    <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
                                    <div class="text-center">Maestro</div>
                                </div>

                                <div class="col-md-4">
                                    <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
                                    <div class="text-center">Padre o Guardian </div>
                                </div>
