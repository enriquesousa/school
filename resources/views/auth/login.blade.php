				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Forma de Entrada</h2>
                            ...
                            @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Entre Correo Electrónico">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Entre Contraseña">
									</div>
								</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a href="{{ route('password.request') }}" class="text-white hover-info"><i class="ion ion-locked"></i> Olvide Contraseña?</a><br>
                                        </div>
                                    </div>
