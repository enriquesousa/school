        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == 'setups') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'student.year.view') ? 'active' : '' }}"><a href="{{ route('student.year.view') }}"><i class="ti-more"></i>Periodos</a></li>
            ...
            <li class="treeview {{ ($prefix == 'accounts') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                     ...
                     <li class="{{ ($route == 'account.salary.view') ? 'active' : '' }}"><a href="{{ route('account.salary.view') }}"><i class="ti-more"></i>Sueldos Empleados</a></li>
                     <li class="{{ ($route == 'other.cost.view') ? 'active' : '' }}"><a href="{{ route('other.cost.view') }}"><i class="ti-more"></i>Otros Costos</a></li>
                </ul>
            </li>
            ...
            <li class="header nav-small-cap">Reportes</li>
             ...
             <li class="treeview {{ ($prefix == 'reports') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                     ...
                     <li class="{{ ($route == 'student.result.view') ? 'active' : '' }}"><a href="{{ route('student.result.view') }}"><i class="ti-more"></i>Resultados Estudiantes</a></li>
                </ul>
            </li>
